                         ...
                         optStruct   &Options)
{
  ...
  ifstream INPUT;
  ifstream INPUT2;           //For Secondary input // JULIE
  CParser *pMainParser=NULL; //for storage of main parser while reading secondary files // JULIE
  ...
  while (!end_of_file) 
    {
      ...
      */
      ...
      else if  (!strcmp(s[0],":RedirectToFile"     )){code=-3; }//redirect to secondary file //JULIE
      ...
      switch(code)
        ...
        case(-3):  //---------------------------------------------- // JULIE
          {/*:RedirectToFile*/
            printf("ParseInput: :Redirect start ....\n");
            string filename="";
            ...
            printf("ParseInput: :Redirect end ....\n");
            break;
          }
        case(-4):  //----------------------------------------------
          {/*:End*/
	...
	case(76):  //--------------------------------------------
      ...
      //return after file redirect, if in secondary file //JULIE
