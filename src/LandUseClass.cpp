...
//const surface_struct &needed_params
{
  ...
  SetSpecifiedValue(S.min_wind_speed,Stmp.min_wind_speed,Sdefault.min_wind_speed,needed,"MIN_WIND_SPEED");
  SetSpecifiedValue(S.max_wind_speed,Stmp.max_wind_speed,Sdefault.max_wind_speed,needed,"MAX_WIND_SPEED");
