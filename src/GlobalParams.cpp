...
void CGlobalParams::AutoCalculateGlobalParams(const global_struct &Gtmp, const global_struct &Gtemplate)
{
  ...
  {
    G.snow_SWI=0.05;
    warn="The required global parameter SNOW_SWI was autogenerated with value "+to_string(G.snow_SWI);
  ...
  autocalc=SetCalculableValue(G.UBC_snow_params.MAX_SNOW_ALBEDO,Gtmp.UBC_snow_params.MAX_SNOW_ALBEDO,Gtemplate.UBC_snow_params.MAX_SNOW_ALBEDO);
  if (autocalc)
  {
    G.UBC_snow_params.MAX_SNOW_ALBEDO=0.95; //[C/km] (UBC default)
    warn="The required global parameter UBC_MAX_SNOW_ALBEDO was autogenerated with value "+to_string(G.UBC_snow_params.MAX_SNOW_ALBEDO);
    if (chatty){WriteWarning(warn,false);}
  }

  autocalc=SetCalculableValue(G.UBC_snow_params.MIN_SNOW_ALBEDO,Gtmp.UBC_snow_params.MIN_SNOW_ALBEDO,Gtemplate.UBC_snow_params.MIN_SNOW_ALBEDO);
  if (autocalc)
  {
    G.UBC_snow_params.MIN_SNOW_ALBEDO=0.3; //[C/km] (UBC default)
    warn="The required global parameter UBC_MIN_SNOW_ALBEDO was autogenerated with value "+to_string(G.UBC_snow_params.MIN_SNOW_ALBEDO);
    if (chatty){WriteWarning(warn,false);}
  }
...
void CGlobalParams::InitializeGlobalParameters(global_struct &g, bool is_template)//static
{
  ...
  g.UBC_snow_params.MAX_SNOW_ALBEDO=DefaultParameterValue(is_template,true);
  g.UBC_snow_params.MIN_SNOW_ALBEDO=DefaultParameterValue(is_template,true);
                                        ...
                                        const double value)
{
  ...
  else if (!name.compare("UBC_MAX_SNOW_ALBEDO" )){G.UBC_snow_params.MAX_SNOW_ALBEDO=value;}
  else if (!name.compare("UBC_MIN_SNOW_ALBEDO" )){G.UBC_snow_params.MIN_SNOW_ALBEDO=value;}
...
double CGlobalParams::GetGlobalProperty(const global_struct &G, string  param_name)
{
  ...
  else if (!name.compare("UBC_MAX_SNOW_ALBEDO" )){return G.UBC_snow_params.MAX_SNOW_ALBEDO;}
  else if (!name.compare("UBC_MIN_SNOW_ALBEDO" )){return G.UBC_snow_params.MIN_SNOW_ALBEDO;}
